    ...
    def main(self,amount,domain):
        ...
        for r in range(1, amount+1):
            ...
            with open(f'GENERATED_EMAILS\\Gmail_{r}.txt', 'w') as login_details:
                login_details.write('Email : '+str(random_hex)+f'{domain}\nPassword : {random_hex[::-1]}')

if __name__ == "__main__":
    app = APP()
    webview.create_window('Email Generator','src/index.html',width=350,height=225,resizable=False,js_api=app)
    webview.start()